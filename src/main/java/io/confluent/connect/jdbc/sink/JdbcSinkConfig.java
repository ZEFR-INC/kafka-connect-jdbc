...
public class JdbcSinkConfig extends AbstractConfig {
  ...
  private static final String TOPIC_NAMES_TO_TABLE_NAMES_DOC =
      "A list of mappings from topic names to table names. These should be comma delimited key "
      + "value pairs (separated by equal signs).\n"
      + "For example, ``kafka_topic=topic`` will map topic 'kafka_topic' to table name 'topic'.";
  private static final String TOPIC_NAMES_TO_TABLE_NAMES_DISPLAY =
      "Topic Names to Table Names Mapping";
  ...
  public static final ConfigDef CONFIG_DEF = new ConfigDef()
        ...
        .define(
            TOPIC_NAMES_TO_TABLE_NAMES,
            ConfigDef.Type.STRING,
            null,
            ConfigDef.Importance.MEDIUM,
            TOPIC_NAMES_TO_TABLE_NAMES_DOC,
            DATAMAPPING_GROUP,
            4,
            ConfigDef.Width.LONG,
            TOPIC_NAMES_TO_TABLE_NAMES_DISPLAY
        )
        .define(
            PK_MODE,
            ConfigDef.Type.STRING,
